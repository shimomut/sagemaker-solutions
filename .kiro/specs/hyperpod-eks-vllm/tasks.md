...
- [ ] 1. Set up project structure and supporting files
...
- [ ] 3. Create the Kubernetes deployment manifest
  - [ ] 3.1 Define the Deployment resource in `deployment.yaml`
  ...
  - [ ] 3.2 Define the Service resource in `deployment.yaml`
...
- [ ] 5. Checkpoint - Verify project structure
...
- [ ] 6. Create the client script
  - [ ] 6.1 Implement `client.py` with argparse accepting `--url` (default `http://localhost:8000`)
...
- [ ] 7. Create the README.md documentation
  - [ ] 7.1 Write overview, prerequisites, and build/deploy sections
  ...
  - [ ] 7.2 Write port-forward, client usage, and configuration sections
  ...
  - [ ] 7.3 Write model switching and Hugging Face authentication sections
...
- [ ] 8. Final checkpoint - Review all files
