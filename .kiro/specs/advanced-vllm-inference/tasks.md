...
- [x] 1. Rename basic experiment and scaffold advanced project
  - [x] 1.1 Move `_experiments/hyperpod_eks_vllm` to `hyperpod_eks_vllm_basic`
  ...
  - [x] 1.2 Create the `hyperpod_eks_vllm_advanced` project structure
...
- [x] 3. Create base vLLM deployment and service manifests
  - [x] 3.1 Create `manifests/vllm-deployment.yaml`
...
- [x] 5. Create ALB Ingress and routing manifests
  - [x] 5.1 Create `manifests/alb-ingress.yaml`
...
- [x] 6. Create Ray Cluster manifest
  - [x] 6.1 Create `manifests/ray-cluster.yaml`
...
- [x] 7. Create Redis and cache proxy
  - [x] 7.1 Create `manifests/redis.yaml`
  ...
  - [x] 7.2 Implement `cache_proxy.py`
...
- [x] 8. Checkpoint - Verify infrastructure manifests and cache proxy
...
- [x] 9. Create monitoring manifests (Prometheus + Grafana)
  - [x] 9.1 Create `manifests/prometheus.yaml`
  ...
  - [x] 9.2 Create `manifests/grafana.yaml`
...
- [x] 10. Create autoscaling manifests (HPA + Prometheus Adapter)
  - [x] 10.1 Create `manifests/hpa.yaml`
  ...
  - [x] 10.2 Create `manifests/prometheus-adapter.yaml`
...
- [x] 11. Create disaggregated serving manifest
  - [x] 11.1 Create `manifests/disaggregated-serving.yaml`
...
- [x] 12. Implement advanced client script
  - [x] 12.1 Implement `client.py`
...
- [x] 13. Implement benchmark script
  - [x] 13.1 Implement `benchmark.py`
...
- [x] 14. Checkpoint - Verify all Python scripts and tests
  - Ensure `client.py`, `benchmark.py`, `cache_proxy.py` exist at project root
  - Ensure all property tests and unit tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Create JSON schema examples and Makefile
  - [x] 15.1 Create JSON schema files in `schemas/`
...
- [x] 16. Create README.md documentation
  - [x] 16.1 Write overview, architecture, and Quick Start sections
  ...
  - [x] 16.2 Write feature sections with configuration and verification
  ...
  - [x] 16.3 Write troubleshooting and learning path sections
...
- [x] 17. Final checkpoint - Verify complete project
