...
- **Slack channel for live investigation updates** — The email notifier's EventBridge listener is the template; a Slack notifier drops into the same `aws.aidevops` event stream.
